...
Letztendlich fiel die Wahl auf die prozedurale Modellierung von Schneedecken,
...
au\ss erhalb eines Objektes liegt, um im Anschluss mit Hilfe des
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=400px]{pictures/singleTopSnow.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=250px]{pictures/topSnowStability.png}
