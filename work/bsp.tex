...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=400px]{pictures/clouds.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=200px]{pictures/voxel.eps}
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \vspace{-10pt}
    \begin{center}
        \includegraphics[width=0.35\textwidth]{pictures/neighborhood.eps}
    \end{center}
    \vspace{-10pt}
...
%\begin{figure}[htbp]
%    \centering
%    \includegraphics[width=200px]{pictures/neighborhood.eps}
%    \caption{Voxelnachbarschaft}
%    \label{fig:voxel_neighborhood}
%\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=300px]{pictures/voxel_grid_rect.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=350px]{pictures/voxel_grid_random.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=400px]{pictures/granularity.png}
